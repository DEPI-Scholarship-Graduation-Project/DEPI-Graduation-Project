...
public class E2ETest extends BaseTest {
    ...
    public void addToCartTest(JsonNode data) {
        ...
        if(expectedProductResult.equalsIgnoreCase("empty")){
            ...
            cartPage = viewProduct.clickOnToastLink();
        ...
        Assert.assertTrue(checkoutPage.getPageTitleElement().isDisplayed());
        ...
        Assert.assertTrue(completePage.getSuccessMsgElement().isDisplayed());

        // click on continue button
        HomePage homePage = completePage.clickOnContinueButton();
        Assert.assertTrue(homePage.verifyIfPageTitleDisplayed());
