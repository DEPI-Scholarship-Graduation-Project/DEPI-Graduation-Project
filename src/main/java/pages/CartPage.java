...
public class CartPage {
    ...
    private final By cartProducts = By.cssSelector(".product .product-name");
    ...
    public List<String> getCartProductsTitle() {
        return driver.findElements(cartProducts).stream().map(WebElement::getText).collect(Collectors.toList());
    }
